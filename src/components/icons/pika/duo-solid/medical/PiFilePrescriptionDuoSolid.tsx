...
/**
 * PiFilePrescriptionDuoSolid icon from the duo-solid style in medical category.
 */
interface PiFilePrescriptionDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFilePrescriptionDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-prescription icon',
  ...props
}: PiFilePrescriptionDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
