...
/**
 * PiFile02PrescriptionDuoSolid icon from the duo-solid style in medical category.
 */
interface PiFile02PrescriptionDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02PrescriptionDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-prescription icon',
  ...props
}: PiFile02PrescriptionDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
