...
/**
 * PiFirstAidDuoSolid icon from the duo-solid style in medical category.
 */
interface PiFirstAidDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFirstAidDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'first-aid icon',
  ...props
}: PiFirstAidDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
