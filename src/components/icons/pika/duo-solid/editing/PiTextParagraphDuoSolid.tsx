...
export default function PiTextParagraphDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 3v18" opacity=".28"/><path fill={color || "currentColor"} fillRule="evenodd" d="M9.03 2a7.03 7.03 0 1 0 0 14.058H12V21a1 1 0 0 0 2 0V4h7a1 1 0 1 0 0-2z" clipRule="evenodd"/>
    </svg>
  );
}
