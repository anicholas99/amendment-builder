...
/**
 * PiChatChattingDuoSolid icon from the duo-solid style in communication category.
 */
interface PiChatChattingDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatChattingDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'chat-chatting icon',
  ...props
}: PiChatChattingDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
