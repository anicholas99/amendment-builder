...
export default function PiKeyRightDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 12h4v3m-4-3h-8m8 0v2" opacity=".28"/><path fill={color || "currentColor"} d="M6 7a5 5 0 1 1 0 10A5 5 0 0 1 6 7Z"/>
    </svg>
  );
}
