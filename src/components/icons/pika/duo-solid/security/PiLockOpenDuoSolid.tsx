...
/**
 * PiLockOpenDuoSolid icon from the duo-solid style in security category.
 */
interface PiLockOpenDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiLockOpenDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'lock-open icon',
  ...props
}: PiLockOpenDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
