...
export default function PiKeyLeftDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 12H2v3m4-3h8m-8 0v2" opacity=".28"/><path fill={color || "currentColor"} d="M18 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10Z"/>
    </svg>
  );
}
