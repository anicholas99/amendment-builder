...
/**
 * PiFile02PlusDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02PlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02PlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-plus icon',
  ...props
}: PiFile02PlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
