...
/**
 * PiFilePngFormatDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFilePngFormatDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFilePngFormatDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-png-format icon',
  ...props
}: PiFilePngFormatDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
