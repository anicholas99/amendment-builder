...
/**
 * PiFile02PdfFormatDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02PdfFormatDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02PdfFormatDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-pdf-format icon',
  ...props
}: PiFile02PdfFormatDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
