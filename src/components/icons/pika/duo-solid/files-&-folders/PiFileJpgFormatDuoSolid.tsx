...
/**
 * PiFileJpgFormatDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileJpgFormatDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileJpgFormatDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-jpg-format icon',
  ...props
}: PiFileJpgFormatDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
