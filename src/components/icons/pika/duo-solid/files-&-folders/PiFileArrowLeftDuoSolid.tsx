...
/**
 * PiFileArrowLeftDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileArrowLeftDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowLeftDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-left icon',
  ...props
}: PiFileArrowLeftDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
