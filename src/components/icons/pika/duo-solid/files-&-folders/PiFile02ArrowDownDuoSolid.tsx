...
/**
 * PiFile02ArrowDownDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02ArrowDownDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02ArrowDownDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-arrow-down icon',
  ...props
}: PiFile02ArrowDownDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
