...
/**
 * PiFileMusicNoteDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileMusicNoteDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileMusicNoteDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-music-note icon',
  ...props
}: PiFileMusicNoteDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
