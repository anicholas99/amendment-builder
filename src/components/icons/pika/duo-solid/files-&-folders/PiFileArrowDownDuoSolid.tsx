...
/**
 * PiFileArrowDownDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileArrowDownDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowDownDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-down icon',
  ...props
}: PiFileArrowDownDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
