...
/**
 * PiFileSearchDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileSearchDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileSearchDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-search icon',
  ...props
}: PiFileSearchDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
