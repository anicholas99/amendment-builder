...
/**
 * PiFileRemoveDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileRemoveDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileRemoveDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-remove icon',
  ...props
}: PiFileRemoveDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
