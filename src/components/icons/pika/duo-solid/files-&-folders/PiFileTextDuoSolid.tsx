...
/**
 * PiFileTextDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileTextDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileTextDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-text icon',
  ...props
}: PiFileTextDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
