...
/**
 * PiFile02CodeDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02CodeDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02CodeDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-code icon',
  ...props
}: PiFile02CodeDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
