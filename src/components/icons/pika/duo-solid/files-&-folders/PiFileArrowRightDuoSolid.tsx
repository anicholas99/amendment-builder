...
/**
 * PiFileArrowRightDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileArrowRightDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowRightDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-right icon',
  ...props
}: PiFileArrowRightDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
