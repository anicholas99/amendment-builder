...
/**
 * PiFileInformationDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileInformationDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileInformationDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-information icon',
  ...props
}: PiFileInformationDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
