 ...
 */
interface PiFile02RemoveDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02RemoveDuoSolid({
  ...
  ...props
}: PiFile02RemoveDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
