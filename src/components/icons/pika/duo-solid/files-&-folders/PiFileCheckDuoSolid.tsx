...
/**
 * PiFileCheckDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-check icon',
  ...props
}: PiFileCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
