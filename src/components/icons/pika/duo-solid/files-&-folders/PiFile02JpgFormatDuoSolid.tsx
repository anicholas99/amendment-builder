...
/**
 * PiFile02JpgFormatDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02JpgFormatDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02JpgFormatDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-jpg-format icon',
  ...props
}: PiFile02JpgFormatDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
