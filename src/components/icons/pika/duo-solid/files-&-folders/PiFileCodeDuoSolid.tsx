...
/**
 * PiFileCodeDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileCodeDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileCodeDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-code icon',
  ...props
}: PiFileCodeDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
