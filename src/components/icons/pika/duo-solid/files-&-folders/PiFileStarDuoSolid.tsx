...
/**
 * PiFileStarDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileStarDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileStarDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-star icon',
  ...props
}: PiFileStarDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
