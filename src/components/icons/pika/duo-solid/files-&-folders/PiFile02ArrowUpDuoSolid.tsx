...
/**
 * PiFile02ArrowUpDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02ArrowUpDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02ArrowUpDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-arrow-up icon',
  ...props
}: PiFile02ArrowUpDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
