...
/**
 * PiFile02ArrowRightDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02ArrowRightDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02ArrowRightDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-arrow-right icon',
  ...props
}: PiFile02ArrowRightDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
