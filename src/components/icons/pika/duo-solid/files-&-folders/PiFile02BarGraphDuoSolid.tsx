 ...
 */
interface PiFile02BarGraphDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02BarGraphDuoSolid({
  ...
  ...props
}: PiFile02BarGraphDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
