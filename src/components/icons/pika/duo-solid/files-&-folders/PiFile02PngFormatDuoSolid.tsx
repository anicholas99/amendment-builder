...
/**
 * PiFile02PngFormatDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02PngFormatDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02PngFormatDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-png-format icon',
  ...props
}: PiFile02PngFormatDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
