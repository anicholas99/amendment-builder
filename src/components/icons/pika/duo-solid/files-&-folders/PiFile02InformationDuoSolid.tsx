 ...
 */
interface PiFile02InformationDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02InformationDuoSolid({
  ...
  ...props
}: PiFile02InformationDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
