...
/**
 * PiFile02TextDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFile02TextDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02TextDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-text icon',
  ...props
}: PiFile02TextDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
