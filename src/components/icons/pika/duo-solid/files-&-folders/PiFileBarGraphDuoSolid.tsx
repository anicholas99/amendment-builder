...
/**
 * PiFileBarGraphDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFileBarGraphDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileBarGraphDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-bar-graph icon',
  ...props
}: PiFileBarGraphDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
