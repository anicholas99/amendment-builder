...
/**
 * PiLayoutGridTwoVerticalDuoSolid icon from the duo-solid style in general category.
 */
interface PiLayoutGridTwoVerticalDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiLayoutGridTwoVerticalDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'layout-grid-two-vertical icon',
  ...props
}: PiLayoutGridTwoVerticalDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
