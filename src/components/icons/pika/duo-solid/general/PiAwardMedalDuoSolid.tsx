...
export default function PiAwardMedalDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16.365 14.473 18 22c-4.286-2.664-7.714-2.664-12 0l1.635-7.527" opacity=".28"/><path fill={color || "currentColor"} d="M12 1a8 8 0 1 0 0 16 8 8 0 0 0 0-16Z"/>
    </svg>
  );
}
