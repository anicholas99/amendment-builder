...
export default function PiSearchBigDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.51 17.51 21 21" opacity=".28"/><path fill={color || "currentColor"} d="M11.5 2a9.5 9.5 0 1 0 0 19 9.5 9.5 0 0 0 0-19Z"/>
    </svg>
  );
}
