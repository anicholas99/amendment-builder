...
export default function PiSearchDefaultDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.95 14.95 21 21" opacity=".28"/><path fill={color || "currentColor"} d="M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Z"/>
    </svg>
  );
}
