...
/**
 * PiFileAIDuoSolid icon from the duo-solid style in ai category.
 */
interface PiFileAIDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileAIDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-ai icon',
  ...props
}: PiFileAIDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
