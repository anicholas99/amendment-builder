...
export default function PiGitBranchRemoveDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 15.5v-1m0 0V3m0 11.5a9 9 0 0 1 9-9" opacity=".28"/><path fill={color || "currentColor"} d="M14 5.5a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z"/><path fill={color || "currentColor"} d="M2 18.5a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z"/><path fill={color || "currentColor"} d="M15 17a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2z"/>
    </svg>
  );
}
