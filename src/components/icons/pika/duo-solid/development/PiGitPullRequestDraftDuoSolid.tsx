...
export default function PiGitPullRequestDraftDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 9v12m12-8v2m-5-9q.514 0 1 .1M17 8q.348.462.584 1" opacity=".28"/><path fill={color || "currentColor"} d="M6 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z"/><path fill={color || "currentColor"} d="M18 14a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z"/>
    </svg>
  );
}
