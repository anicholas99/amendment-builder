...
export default function PiGitCommitDuoSolid({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke={color || "currentColor"} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12h6m6 0h6" opacity=".28"/><path fill={color || "currentColor"} d="M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z"/>
    </svg>
  );
}
