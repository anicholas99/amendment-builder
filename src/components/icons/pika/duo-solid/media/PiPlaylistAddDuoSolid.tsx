...
/**
 * PiPlaylistAddDuoSolid icon from the duo-solid style in media category.
 */
interface PiPlaylistAddDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistAddDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-add icon',
  ...props
}: PiPlaylistAddDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
