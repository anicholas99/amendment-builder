...
/**
 * PiPhotoImagePlusDuoSolid icon from the duo-solid style in media category.
 */
interface PiPhotoImagePlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhotoImagePlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'photo-image-plus icon',
  ...props
}: PiPhotoImagePlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
