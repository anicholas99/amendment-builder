...
/**
 * PiPhotoImageCheckDuoSolid icon from the duo-solid style in media category.
 */
interface PiPhotoImageCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhotoImageCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'photo-image-check icon',
  ...props
}: PiPhotoImageCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
