...
/**
 * PiPlaylistUserDuoSolid icon from the duo-solid style in media category.
 */
interface PiPlaylistUserDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistUserDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-user icon',
  ...props
}: PiPlaylistUserDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
