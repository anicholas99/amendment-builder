...
/**
 * PiPhotoImageArrowRightDuoSolid icon from the duo-solid style in media category.
 */
interface PiPhotoImageArrowRightDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhotoImageArrowRightDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'photo-image-arrow-right icon',
  ...props
}: PiPhotoImageArrowRightDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
