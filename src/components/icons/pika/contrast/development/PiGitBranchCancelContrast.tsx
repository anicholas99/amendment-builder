...
export default function PiGitBranchCancelContrast({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g fill="currentColor" opacity=".28"><path d="M21 5.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="none" stroke="currentColor"/><path d="M9 18.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="none" stroke="currentColor"/></g><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 15.5V3m0 12.5a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm9-10a3 3 0 1 0 6 0 3 3 0 0 0-6 0Zm0 0a9 9 0 0 0-9 9m10 6.8 2.4-2.4m0 0 2.4-2.4m-2.4 2.4L16 16.5m2.4 2.4 2.4 2.4" fill="none"/>
    </svg>
  );
}
