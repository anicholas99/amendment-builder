...
export default function PiPriorityBlockerContrast({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill="currentColor" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" opacity=".28" stroke="currentColor"/><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m8.5 15.5 7-7M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" fill="none"/>
    </svg>
  );
}
