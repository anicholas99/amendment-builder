...
export default function PiUserGraduationHatContrast({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g fill="currentColor" opacity=".28"><path d="M16 15H8a4 4 0 0 0-4 4 2 2 0 0 0 2 2h12a2 2 0 0 0 2-2 4 4 0 0 0-4-4Z" fill="none" stroke="currentColor"/><path d="m5 4 7-2 7 2-7 2z" fill="none" stroke="currentColor"/></g><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m5 4 7-2 7 2-3.53 1.009M5 4l3.53 1.009M5 4v3m10.47-1.991L12 6l-3.47-.991m6.94 0a4 4 0 1 1-6.94 0M8 15a4 4 0 0 0-4 4 2 2 0 0 0 2 2h12a2 2 0 0 0 2-2 4 4 0 0 0-4-4z" fill="none"/>
    </svg>
  );
}
