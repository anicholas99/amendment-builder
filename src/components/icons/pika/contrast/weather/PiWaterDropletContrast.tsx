...
export default function PiWaterDropletContrast({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 3c13 11 5.712 18 0 18s-13-7 0-18Z" fill="none"/><path fill="currentColor" d="M12 3c13 11 5.712 18 0 18s-13-7 0-18Z" opacity=".28" stroke="currentColor"/>
    </svg>
  );
}
