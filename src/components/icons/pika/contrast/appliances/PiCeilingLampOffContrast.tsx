...
export default function PiCeilingLampOffContrast({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill="currentColor" d="M12 7a9 9 0 0 0-9 9h18a9 9 0 0 0-9-9Z" opacity=".28" stroke="currentColor"/><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 7a9 9 0 0 0-9 9h18a9 9 0 0 0-9-9Zm0 0V4m3 12a3 3 0 1 1-6 0z" fill="none"/>
    </svg>
  );
}
