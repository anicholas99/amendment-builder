...
export default function PiMapPin02Contrast({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill="currentColor" d="M17 8A5 5 0 1 1 7 8a5 5 0 0 1 10 0Z" opacity=".28" stroke="currentColor"/><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 13a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0 0v8" fill="none"/>
    </svg>
  );
}
