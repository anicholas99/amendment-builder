...
export default function PiKeyLeftContrast({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill="currentColor" d="M22 12a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z" opacity=".28" stroke="currentColor"/><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 12a4 4 0 1 0 8 0 4 4 0 0 0-8 0Zm0 0H2v3m4-3v2" fill="none"/>
    </svg>
  );
}
