  ...
  'relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-slate-950 dark:[&>svg]:text-slate-50',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-red-500/50 text-red-900 dark:border-red-500 [&>svg]:text-red-600 dark:border-red-900/50 dark:text-red-50 dark:dark:border-red-900 dark:[&>svg]:text-red-500',
      },
    },
    defaultVariants: {
      variant: 'default',
