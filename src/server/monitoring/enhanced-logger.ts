/**
 * Enhanced logger for specialized logging needs
 *
 * For general logging, use: import { logger } from '@/server/logger'
 * This file provides additional specialized logging functions.
 */
...
// Re-export the main logger for backward compatibility
export { logger } from '@/server/logger';

// Get environment
const env = environment.env;

// Create the main logger instance for specialized logging
