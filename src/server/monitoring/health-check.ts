...
import { HealthStatus, HealthCheckResult, SystemHealth } from '@/types/health';
...
// Remove singleton instance and factory function
// Health check service is now provided via request-scoped services
